        ...
        <div className="container my-5">
            ...
            <div id="mainCarousel" className="carousel slide mb-5" data-bs-ride="carousel">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img
                            src={`${backendUrl}/uploads/images/home/carrusel/carru1.jpg`}
                    ...
                    <div className="carousel-item">
                        <img
                            src={`${backendUrl}/uploads/images/home/carrusel/carru2.jpg`}
                            className="d-block w-100"
                    ...
                    <div className="carousel-item">
                        <img
                            src={`${backendUrl}/uploads/images/home/carrusel/carru3.jpg`}
                            className="d-block w-100"
            ...
            <div className="row text-center">
                <div className="col-md-4 mb-4">
                    <Link to="/dogs">
                        <img
                            src={`${backendUrl}/uploads/images/home/iconos/perros.jpg`}
                            alt="Enlace a productos para perros"
                ...
                <div className="col-md-4 mb-4">
                    <Link to="/cats">
                        <img
                            src={`${backendUrl}/uploads/images/home/iconos/gatos.jpg`}
                            alt="Enlace a productos para gatos"
                            className="img-fluid rounded-circle mb-2"
                        />
                        <h5>Gatos</h5>
                    </Link>
                ...
                <div className="col-md-4 mb-4">
                    <Link to="/promotions">
                        <img
                            src={`${backendUrl}/uploads/images/home/iconos/promociones.jpg`}
                            alt="Enlace a promociones"
                            className="img-fluid rounded-circle mb-2"
                        />
                        <h5>Promociones</h5>
                    </Link>
